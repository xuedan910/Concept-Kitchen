...
--
-- 表的结构 `wpcn_commentmeta`
--

CREATE TABLE IF NOT EXISTS `wpcn_commentmeta` (
...
CREATE TABLE IF NOT EXISTS `wpcn_comments` (
...
--
-- 转存表中的数据 `wpcn_comments`
--

INSERT INTO `wpcn_comments` (`comment_ID`, `comment_post_ID`, `comment_author`, `comment_author_email`, `comment_author_url`, `comment_author_IP`, `comment_date`, `comment_date_gmt`, `comment_content`, `comment_karma`, `comment_approved`, `comment_agent`, `comment_type`, `comment_parent`, `user_id`) VALUES
...
--
-- 表的结构 `wpcn_layerslider`
--

CREATE TABLE IF NOT EXISTS `wpcn_layerslider` (
...
CREATE TABLE IF NOT EXISTS `wpcn_links` (
...
CREATE TABLE IF NOT EXISTS `wpcn_options` (
...
--
-- 转存表中的数据 `wpcn_options`
--

INSERT INTO `wpcn_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
(1, 'siteurl', 'http://stoneappliance.co.nz/cn', 'yes'),
(2, 'home', 'http://stoneappliance.co.nz/cn', 'yes'),
...
(99, 'sidebars_widgets', 'a:9:{s:19:"wpcn_inactive_widgets";a:0:{}s:8:"rightbar";a:2:{i:0;s:12:"categories-2";i:1;s:18:"facetious_widget-2";}s:15:"feature-widgets";a:0:{}s:22:"single-project-widgets";a:0:{}s:14:"client-widgets";a:0:{}s:19:"testimonial-widgets";a:0:{}s:15:"service-widgets";a:0:{}s:12:"team-widgets";a:0:{}s:13:"array_version";i:3;}', 'yes'),
(100, 'widget_pages', 'a:1:{s:12:"_multiwidget";i:1;}', 'yes'),
(101, 'widget_calendar', 'a:1:{s:12:"_multiwidget";i:1;}', 'yes'),
(102, 'widget_tag_cloud', 'a:1:{s:12:"_multiwidget";i:1;}', 'yes'),
(103, 'widget_nav_menu', 'a:1:{s:12:"_multiwidget";i:1;}', 'yes'),
(104, 'cron', 'a:4:{i:1476287023;a:3:{s:16:"wpcn_version_check";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:17:"wpcn_update_plugins";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}s:16:"wpcn_update_themes";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:10:"twicedaily";s:4:"args";a:0:{}s:8:"interval";i:43200;}}}i:1476330282;a:1:{s:19:"wpcn_scheduled_delete";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}i:1476330727;a:1:{s:30:"wpcn_scheduled_auto_draft_delete";a:1:{s:32:"40cd750bba9870f18aada2478b24840a";a:3:{s:8:"schedule";s:5:"daily";s:4:"args";a:0:{}s:8:"interval";i:86400;}}}s:7:"version";i:2;}', 'yes'),
...
(223, '_transient_timeout__redux_activation_redirect', '1476268411', 'no'),
...
(134, 'theme_mods_twentysixteen', 'a:1:{s:16:"sidebars_widgets";a:2:{s:4:"time";i:1476243906;s:4:"data";a:2:{s:19:"wpcn_inactive_widgets";a:0:{}s:9:"sidebar-1";a:6:{i:0;s:8:"search-2";i:1;s:14:"recent-posts-2";i:2;s:17:"recent-comments-2";i:3;s:10:"archives-2";i:4;s:12:"categories-2";i:5;s:6:"meta-2";}}}}', 'yes'),
...
(230, 'revslider-update-check-short', '1476259420', 'yes'),
...
(277, 'revslider-latest-version', '5.2.6', 'yes');
...
CREATE TABLE IF NOT EXISTS `wpcn_postmeta` (
  `meta_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `wpcn_postmeta`
--

INSERT INTO `wpcn_postmeta` (`meta_id`, `post_id`, `meta_key`, `meta_value`) VALUES
(1, 2, '_wpcn_page_template', 'default'),
(2, 1, '_wpcn_trash_meta_status', 'publish'),
(3, 1, '_wpcn_trash_meta_time', '1476244321'),
(4, 1, '_wpcn_desired_post_slug', 'hello-world'),
(5, 1, '_wpcn_trash_meta_comments_status', 'a:1:{i:1;s:1:"1";}'),
(6, 5, '_edit_last', '1'),
(7, 5, '_edit_lock', '1476252698:1'),
(10, 8, '_edit_last', '1'),
(11, 8, '_edit_lock', '1476252940:1'),
(13, 10, '_edit_last', '1'),
(14, 10, '_edit_lock', '1476259014:1'),
(16, 13, '_edit_last', '1'),
...
(34, 2, '_wpcn_trash_meta_status', 'publish'),
(35, 2, '_wpcn_trash_meta_time', '1476244684'),
(36, 2, '_wpcn_desired_post_slug', 'sample-page'),
(37, 26, '_edit_last', '1'),
(38, 26, '_edit_lock', '1476249441:1'),
(39, 26, '_wpcn_page_template', 'template_home.php'),
(40, 28, '_form', '<label> 你的名字 （必填）\n    [text* your-name] </label>\n\n<label> 你的邮箱 （必填）\n    [email* your-email] </label>\n\n<label> 主题\n    [text your-subject] </label>\n\n<label> 你的留言\n    [textarea your-message] </label>\n\n[submit "发送"]'),
(41, 28, '_mail', 'a:8:{s:7:"subject";s:32:"Concept Kitchen "[your-subject]"";s:6:"sender";s:30:"[your-name] <478996650@qq.com>";s:4:"body";s:184:"发件人：[your-name] <[your-email]>\n主题：[your-subject]\n\n留言正文：\n[your-message]\n\n--\n这封邮件通过联系表单【Concept Kitchen (http://stoneappliance.co.nz/cn)】发送";s:9:"recipient";s:16:"478996650@qq.com";s:18:"additional_headers";s:22:"Reply-To: [your-email]";s:11:"attachments";s:0:"";s:8:"use_html";i:0;s:13:"exclude_blank";i:0;}'),
(42, 28, '_mail_2', 'a:9:{s:6:"active";b:0;s:7:"subject";s:32:"Concept Kitchen "[your-subject]"";s:6:"sender";s:34:"Concept Kitchen <478996650@qq.com>";s:4:"body";s:120:"留言正文：\n[your-message]\n\n--\n这封邮件通过联系表单【Concept Kitchen (http://stoneappliance.co.nz/cn)】发送";s:9:"recipient";s:12:"[your-email]";s:18:"additional_headers";s:26:"Reply-To: 478996650@qq.com";s:11:"attachments";s:0:"";s:8:"use_html";i:0;s:13:"exclude_blank";i:0;}'),
...
(53, 29, '_menu_item_url', 'http://stoneappliance.co.nz/cn/'),
...
(111, 52, '_menu_item_url', 'http://stoneappliance.co.nz/cn/'),
...
(387, 103, '_wpcn_attached_file', '2016/10/Net-study-progress.pdf'),
...
CREATE TABLE IF NOT EXISTS `wpcn_posts` (
...
(1, 1, '2016-10-12 11:43:42', '2016-10-12 03:43:42', '欢迎使用WordPress。这是您的第一篇文章。编辑或删除它，然后开始写作吧！', '世界，您好！', '', 'trash', 'open', 'open', '', 'hello-world__trashed', '', '', '2016-10-12 11:52:01', '2016-10-12 03:52:01', '', 0, 'http://stoneappliance.co.nz/cn/?p=1', 0, 'post', '', 1),
(2, 1, '2016-10-12 11:43:42', '2016-10-12 03:43:42', '这是一个范例页面。它和博客文章不同，因为它的页面位置是固定的，同时会显示于您的博客导航栏（大多数主题中）。大多数人会新增一个“关于”页面向访客介绍自己。它可能类似下面这样：\n\n<blockquote>我是一个很有趣的人，我创建了工厂和庄园。并且，顺便提一下，我的妻子也很好。</blockquote>\n\n……或下面这样：\n\n<blockquote>XYZ装置公司成立于1971年，公司成立以来，我们一直向市民提供高品质的装置。我们位于北京市，有超过2,000名员工，对北京市有着相当大的贡献。</blockquote>\n\n作为一个新的WordPress用户，您可以前往<a href="http://stoneappliance.co.nz/cn/wp-admin/">您的仪表盘</a>删除这个页面，并建立属于您的全新内容。祝您使用愉快！', '示例页面', '', 'trash', 'closed', 'open', '', 'sample-page__trashed', '', '', '2016-10-12 11:58:04', '2016-10-12 03:58:04', '', 0, 'http://stoneappliance.co.nz/cn/?page_id=2', 0, 'page', '', 0),
(3, 1, '2016-10-12 11:43:55', '0000-00-00 00:00:00', '', '自动草稿', '', 'auto-draft', 'open', 'open', '', '', '', '', '2016-10-12 11:43:55', '0000-00-00 00:00:00', '', 0, 'http://stoneappliance.co.nz/cn/?p=3', 0, 'post', '', 0),
(4, 1, '2016-10-12 11:52:01', '2016-10-12 03:52:01', '欢迎使用WordPress。这是您的第一篇文章。编辑或删除它，然后开始写作吧！', '世界，您好！', '', 'inherit', 'closed', 'closed', '', '1-revision-v1', '', '', '2016-10-12 11:52:01', '2016-10-12 03:52:01', '', 1, 'http://stoneappliance.co.nz/cn/2016/10/12/1-revision-v1/', 0, 'revision', '', 0),
(5, 1, '2016-10-12 11:53:19', '2016-10-12 03:53:19', '<a href="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/Net-study-progress.pdf">net-study-progress</a>', 'manual', '', 'publish', 'open', 'open', '', 'manual', '', '', '2016-10-12 14:13:03', '2016-10-12 06:13:03', '', 0, 'http://stoneappliance.co.nz/cn/?p=5', 0, 'post', '', 0),
(104, 1, '2016-10-12 14:13:03', '2016-10-12 06:13:03', '<a href="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/Net-study-progress.pdf">net-study-progress</a>', 'manual', '', 'inherit', 'closed', 'closed', '', '5-revision-v1', '', '', '2016-10-12 14:13:03', '2016-10-12 06:13:03', '', 5, 'http://stoneappliance.co.nz/cn/2016/10/12/5-revision-v1/', 0, 'revision', '', 0),
(7, 1, '2016-10-12 11:53:19', '2016-10-12 03:53:19', '<a href="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/Net-study-progress.pdf">net-study-progress</a>\r\n\r\n<a href="http://localhost:8080/wordpress/wp-content/uploads/2016/09/JavaScript权威指南.pdf">Js指南</a>', 'manual', '', 'inherit', 'closed', 'closed', '', '5-revision-v1', '', '', '2016-10-12 11:53:19', '2016-10-12 03:53:19', '', 5, 'http://stoneappliance.co.nz/cn/2016/10/12/5-revision-v1/', 0, 'revision', '', 0),
(8, 1, '2016-10-12 11:53:51', '2016-10-12 03:53:51', '[ultimate-faqs]', 'Questions&Answers', '', 'publish', 'open', 'open', '', 'questionsanswers', '', '', '2016-10-12 14:16:45', '2016-10-12 06:16:45', '', 0, 'http://stoneappliance.co.nz/cn/?p=8', 0, 'post', '', 0),
(9, 1, '2016-10-12 11:53:51', '2016-10-12 03:53:51', '[ultimate-faqs]', 'Questions&Answers', '', 'inherit', 'closed', 'closed', '', '8-revision-v1', '', '', '2016-10-12 11:53:51', '2016-10-12 03:53:51', '', 8, 'http://stoneappliance.co.nz/cn/2016/10/12/8-revision-v1/', 0, 'revision', '', 0),
(10, 1, '2016-10-12 11:54:19', '2016-10-12 03:54:19', '[Total_Soft_Gallery_Video id="2"]', 'Gallery--one', '', 'publish', 'open', 'open', '', 'gallery-one', '', '', '2016-10-12 14:28:29', '2016-10-12 06:28:29', '', 0, 'http://stoneappliance.co.nz/cn/?p=10', 0, 'post', '', 0),
(11, 1, '2016-10-12 11:54:19', '2016-10-12 03:54:19', '[Total_Soft_Gallery_Video id="1"]', 'Gallery--one', '', 'inherit', 'closed', 'closed', '', '10-revision-v1', '', '', '2016-10-12 11:54:19', '2016-10-12 03:54:19', '', 10, 'http://stoneappliance.co.nz/cn/2016/10/12/10-revision-v1/', 0, 'revision', '', 0),
(12, 1, '2016-10-12 11:54:25', '0000-00-00 00:00:00', '', '自动草稿', '', 'auto-draft', 'open', 'open', '', '', '', '', '2016-10-12 11:54:25', '0000-00-00 00:00:00', '', 0, 'http://stoneappliance.co.nz/cn/?p=12', 0, 'post', '', 0),
(13, 1, '2016-10-12 11:54:55', '2016-10-12 03:54:55', '', 'Home Entertainment', '', 'publish', 'open', 'open', '', 'home-entertainment', '', '', '2016-10-12 11:54:55', '2016-10-12 03:54:55', '', 0, 'http://stoneappliance.co.nz/cn/?p=13', 0, 'post', '', 0),
(14, 1, '2016-10-12 11:54:55', '2016-10-12 03:54:55', '', 'Home Entertainment', '', 'inherit', 'closed', 'closed', '', '13-revision-v1', '', '', '2016-10-12 11:54:55', '2016-10-12 03:54:55', '', 13, 'http://stoneappliance.co.nz/cn/2016/10/12/13-revision-v1/', 0, 'revision', '', 0),
(15, 1, '2016-10-12 11:55:22', '2016-10-12 03:55:22', '', 'Kitchen Whiteware', '', 'publish', 'open', 'open', '', 'kitchen-whiteware', '', '', '2016-10-12 11:55:22', '2016-10-12 03:55:22', '', 0, 'http://stoneappliance.co.nz/cn/?p=15', 0, 'post', '', 0),
(16, 1, '2016-10-12 11:55:22', '2016-10-12 03:55:22', '', 'Kitchen Whiteware', '', 'inherit', 'closed', 'closed', '', '15-revision-v1', '', '', '2016-10-12 11:55:22', '2016-10-12 03:55:22', '', 15, 'http://stoneappliance.co.nz/cn/2016/10/12/15-revision-v1/', 0, 'revision', '', 0),
(17, 1, '2016-10-12 11:55:43', '2016-10-12 03:55:43', '', 'Home Appliances', '', 'publish', 'open', 'open', '', 'home-appliances', '', '', '2016-10-12 11:55:43', '2016-10-12 03:55:43', '', 0, 'http://stoneappliance.co.nz/cn/?p=17', 0, 'post', '', 0),
(18, 1, '2016-10-12 11:55:43', '2016-10-12 03:55:43', '', 'Home Appliances', '', 'inherit', 'closed', 'closed', '', '17-revision-v1', '', '', '2016-10-12 11:55:43', '2016-10-12 03:55:43', '', 17, 'http://stoneappliance.co.nz/cn/2016/10/12/17-revision-v1/', 0, 'revision', '', 0),
(19, 1, '2016-10-12 11:56:12', '2016-10-12 03:56:12', '', 'Hot Deal--one', '', 'publish', 'open', 'open', '', 'hot-deal-one', '', '', '2016-10-12 11:56:12', '2016-10-12 03:56:12', '', 0, 'http://stoneappliance.co.nz/cn/?p=19', 0, 'post', '', 0),
(20, 1, '2016-10-12 11:56:12', '2016-10-12 03:56:12', '', 'Hot Deal--one', '', 'inherit', 'closed', 'closed', '', '19-revision-v1', '', '', '2016-10-12 11:56:12', '2016-10-12 03:56:12', '', 19, 'http://stoneappliance.co.nz/cn/2016/10/12/19-revision-v1/', 0, 'revision', '', 0),
(21, 1, '2016-10-12 11:56:39', '2016-10-12 03:56:39', '', 'Furniture–two', '', 'publish', 'open', 'open', '', 'furniture-two', '', '', '2016-10-12 11:56:39', '2016-10-12 03:56:39', '', 0, 'http://stoneappliance.co.nz/cn/?p=21', 0, 'post', '', 0),
(22, 1, '2016-10-12 11:56:39', '2016-10-12 03:56:39', '', 'Furniture–two', '', 'inherit', 'closed', 'closed', '', '21-revision-v1', '', '', '2016-10-12 11:56:39', '2016-10-12 03:56:39', '', 21, 'http://stoneappliance.co.nz/cn/2016/10/12/21-revision-v1/', 0, 'revision', '', 0),
(23, 1, '2016-10-12 11:57:41', '2016-10-12 03:57:41', '<p style="text-align: left;">[Total_Soft_Gallery_Video id="1"]</p>\r\nThe kitchen is the heart of a home; it is where meals are cooked, meaning conversations happen, and everyone gets the bulk of their nutrition, both physical and emotional. There is something to be said for a sweet, quaint little space, and there is also something significant about a super-sleek, ultra-modern space with all the latest finishes. Kitchen is the hub of your home.\r\n\r\n[slideshow_deploy id=''95'']', 'Furniture–one', '', 'publish', 'open', 'open', '', 'furniture-one', '', '', '2016-10-12 14:09:02', '2016-10-12 06:09:02', '', 0, 'http://stoneappliance.co.nz/cn/?p=23', 0, 'post', '', 0),
(24, 1, '2016-10-12 11:57:41', '2016-10-12 03:57:41', '<p style="text-align: left;">[Total_Soft_Gallery_Video id="2"]</p>\r\nThe kitchen is the heart of a home; it is where meals are cooked, meaning conversations happen, and everyone gets the bulk of their nutrition, both physical and emotional. There is something to be said for a sweet, quaint little space, and there is also something significant about a super-sleek, ultra-modern space with all the latest finishes. Kitchen is the hub of your home.\r\n\r\n[slideshow_deploy id=''23024'']', 'Furniture–one', '', 'inherit', 'closed', 'closed', '', '23-revision-v1', '', '', '2016-10-12 11:57:41', '2016-10-12 03:57:41', '', 23, 'http://stoneappliance.co.nz/cn/2016/10/12/23-revision-v1/', 0, 'revision', '', 0),
(25, 1, '2016-10-12 11:58:04', '2016-10-12 03:58:04', '这是一个范例页面。它和博客文章不同，因为它的页面位置是固定的，同时会显示于您的博客导航栏（大多数主题中）。大多数人会新增一个“关于”页面向访客介绍自己。它可能类似下面这样：\n\n<blockquote>我是一个很有趣的人，我创建了工厂和庄园。并且，顺便提一下，我的妻子也很好。</blockquote>\n\n……或下面这样：\n\n<blockquote>XYZ装置公司成立于1971年，公司成立以来，我们一直向市民提供高品质的装置。我们位于北京市，有超过2,000名员工，对北京市有着相当大的贡献。</blockquote>\n\n作为一个新的WordPress用户，您可以前往<a href="http://stoneappliance.co.nz/cn/wp-admin/">您的仪表盘</a>删除这个页面，并建立属于您的全新内容。祝您使用愉快！', '示例页面', '', 'inherit', 'closed', 'closed', '', '2-revision-v1', '', '', '2016-10-12 11:58:04', '2016-10-12 03:58:04', '', 2, 'http://stoneappliance.co.nz/cn/2016/10/12/2-revision-v1/', 0, 'revision', '', 0),
(26, 1, '2016-10-12 12:01:43', '2016-10-12 04:01:43', '<p style="text-align: center;">[2jslideshow id="86"]</p>\r\n<p style="text-align: center;"><img class="aligncenter wp-image-77 size-full" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/service_img.jpg" alt="service_img" width="1139" height="86" /></p>\r\n<p style="text-align: center;"><img class="alignnone size-full wp-image-78" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-1.jpg" alt="images-1" width="259" height="194" /></p>\r\n\r\n<div class="items-group no-divider">\r\n<div class="content-block">\r\n<div class="content-block-inner">\r\n<div class="text-section">\r\n\r\n<span style="font-size: 15px;">Thank you for choosing a Concept home appliance. To make sure you get the best care if repair should be necessary, Concept offers comprehensive service for your appliance, in the high quality you have come to expect.</span>\r\n<a href="http://localhost:8080/wordpress/?page_id=22721"><img class="alignnone wp-image-23015" style="margin-left: 100px;" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/contact_us-1.jpg" alt="contact_us" width="160" height="171" /></a>                            <a href=" http://localhost:8080/conceptkitchen/?page_id=22698"><img class="alignnone wp-image-23011" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/shop-150x150.jpg" alt="shop" width="170" height="170" /></a>                   <a href=" http://localhost:8080/conceptkitchen/?page_id=22711"><img class="alignnone wp-image-23010" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-2-150x150.jpg" alt="images" width="170" height="170" /></a>\r\n\r\n</div>\r\n</div>\r\n</div>\r\n</div>', 'Home', '', 'publish', 'closed', 'closed', '', 'home', '', '', '2016-10-12 13:04:14', '2016-10-12 05:04:14', '', 0, 'http://stoneappliance.co.nz/cn/?page_id=26', 0, 'page', '', 0),
(27, 1, '2016-10-12 12:01:43', '2016-10-12 04:01:43', '<p style="text-align: center;">[2jslideshow id="22995"]</p>\r\n<p style="text-align: center;"></p>', 'Home', '', 'inherit', 'closed', 'closed', '', '26-revision-v1', '', '', '2016-10-12 12:01:43', '2016-10-12 04:01:43', '', 26, 'http://stoneappliance.co.nz/cn/2016/10/12/26-revision-v1/', 0, 'revision', '', 0),
(28, 1, '2016-10-12 12:04:19', '2016-10-12 04:04:19', '<label> 你的名字 （必填）\n    [text* your-name] </label>\n\n<label> 你的邮箱 （必填）\n    [email* your-email] </label>\n\n<label> 主题\n    [text your-subject] </label>\n\n<label> 你的留言\n    [textarea your-message] </label>\n\n[submit "发送"]\nConcept Kitchen "[your-subject]"\n[your-name] <478996650@qq.com>\n发件人：[your-name] <[your-email]>\n主题：[your-subject]\n\n留言正文：\n[your-message]\n\n--\n这封邮件通过联系表单【Concept Kitchen (http://stoneappliance.co.nz/cn)】发送\n478996650@qq.com\nReply-To: [your-email]\n\n0\n0\n\nConcept Kitchen "[your-subject]"\nConcept Kitchen <478996650@qq.com>\n留言正文：\n[your-message]\n\n--\n这封邮件通过联系表单【Concept Kitchen (http://stoneappliance.co.nz/cn)】发送\n[your-email]\nReply-To: 478996650@qq.com\n\n0\n0\nThank you for your message. It has been sent.\nThere was an error trying to send your message. Please try again later.\nOne or more fields have an error. Please check and try again.\nThere was an error trying to send your message. Please try again later.\nYou must accept the terms and conditions before sending your message.\nThe field is required.\nThe field is too long.\nThe field is too short.', '联系表单 1', '', 'publish', 'closed', 'closed', '', '%e8%81%94%e7%b3%bb%e8%a1%a8%e5%8d%95-1', '', '', '2016-10-12 12:04:19', '2016-10-12 04:04:19', '', 0, 'http://stoneappliance.co.nz/cn/?post_type=wpcf7_contact_form&p=28', 0, 'wpcf7_contact_form', '', 0),
(29, 1, '2016-10-12 12:11:03', '0000-00-00 00:00:00', '', '首页', '', 'draft', 'closed', 'closed', '', '', '', '', '2016-10-12 12:11:03', '0000-00-00 00:00:00', '', 0, 'http://stoneappliance.co.nz/cn/?p=29', 1, 'nav_menu_item', '', 0),
(30, 1, '2016-10-12 12:11:03', '0000-00-00 00:00:00', ' ', '', '', 'draft', 'closed', 'closed', '', '', '', '', '2016-10-12 12:11:03', '0000-00-00 00:00:00', '', 0, 'http://stoneappliance.co.nz/cn/?p=30', 1, 'nav_menu_item', '', 0),
(31, 1, '2016-10-12 12:12:23', '2016-10-12 04:12:23', '', 'About Us', '', 'publish', 'closed', 'closed', '', 'about-us', '', '', '2016-10-12 12:12:23', '2016-10-12 04:12:23', '', 0, 'http://stoneappliance.co.nz/cn/?page_id=31', 0, 'page', '', 0),
(32, 1, '2016-10-12 12:12:23', '2016-10-12 04:12:23', '', 'About Us', '', 'inherit', 'closed', 'closed', '', '31-revision-v1', '', '', '2016-10-12 12:12:23', '2016-10-12 04:12:23', '', 31, 'http://stoneappliance.co.nz/cn/2016/10/12/31-revision-v1/', 0, 'revision', '', 0),
(33, 1, '2016-10-12 12:12:47', '2016-10-12 04:12:47', '', 'Shop', '', 'publish', 'closed', 'closed', '', 'shop', '', '', '2016-10-12 12:12:47', '2016-10-12 04:12:47', '', 0, 'http://stoneappliance.co.nz/cn/?page_id=33', 0, 'page', '', 0),
(34, 1, '2016-10-12 12:12:47', '2016-10-12 04:12:47', '', 'Shop', '', 'inherit', 'closed', 'closed', '', '33-revision-v1', '', '', '2016-10-12 12:12:47', '2016-10-12 04:12:47', '', 33, 'http://stoneappliance.co.nz/cn/2016/10/12/33-revision-v1/', 0, 'revision', '', 0),
(35, 1, '2016-10-12 12:13:19', '2016-10-12 04:13:19', '', 'Hot Deal', '', 'publish', 'closed', 'closed', '', 'hot-deal', '', '', '2016-10-12 12:13:19', '2016-10-12 04:13:19', '', 33, 'http://stoneappliance.co.nz/cn/?page_id=35', 0, 'page', '', 0),
(36, 1, '2016-10-12 12:13:19', '2016-10-12 04:13:19', '', 'Hot Deal', '', 'inherit', 'closed', 'closed', '', '35-revision-v1', '', '', '2016-10-12 12:13:19', '2016-10-12 04:13:19', '', 35, 'http://stoneappliance.co.nz/cn/2016/10/12/35-revision-v1/', 0, 'revision', '', 0),
(37, 1, '2016-10-12 12:13:41', '2016-10-12 04:13:41', '', 'Furniture', '', 'publish', 'closed', 'closed', '', 'furniture', '', '', '2016-10-12 12:13:41', '2016-10-12 04:13:41', '', 33, 'http://stoneappliance.co.nz/cn/?page_id=37', 1, 'page', '', 0),
(38, 1, '2016-10-12 12:13:41', '2016-10-12 04:13:41', '', 'Furniture', '', 'inherit', 'closed', 'closed', '', '37-revision-v1', '', '', '2016-10-12 12:13:41', '2016-10-12 04:13:41', '', 37, 'http://stoneappliance.co.nz/cn/2016/10/12/37-revision-v1/', 0, 'revision', '', 0),
(39, 1, '2016-10-12 12:14:16', '2016-10-12 04:14:16', '', 'Home Entertainment', '', 'publish', 'closed', 'closed', '', 'home-entertainment', '', '', '2016-10-12 12:14:16', '2016-10-12 04:14:16', '', 33, 'http://stoneappliance.co.nz/cn/?page_id=39', 2, 'page', '', 0),
(40, 1, '2016-10-12 12:14:16', '2016-10-12 04:14:16', '', 'Home Entertainment', '', 'inherit', 'closed', 'closed', '', '39-revision-v1', '', '', '2016-10-12 12:14:16', '2016-10-12 04:14:16', '', 39, 'http://stoneappliance.co.nz/cn/2016/10/12/39-revision-v1/', 0, 'revision', '', 0),
(41, 1, '2016-10-12 12:14:37', '2016-10-12 04:14:37', '', 'Home Appliances', '', 'publish', 'closed', 'closed', '', 'home-appliances', '', '', '2016-10-12 12:14:37', '2016-10-12 04:14:37', '', 33, 'http://stoneappliance.co.nz/cn/?page_id=41', 3, 'page', '', 0),
(42, 1, '2016-10-12 12:14:37', '2016-10-12 04:14:37', '', 'Home Appliances', '', 'inherit', 'closed', 'closed', '', '41-revision-v1', '', '', '2016-10-12 12:14:37', '2016-10-12 04:14:37', '', 41, 'http://stoneappliance.co.nz/cn/2016/10/12/41-revision-v1/', 0, 'revision', '', 0),
(43, 1, '2016-10-12 12:15:15', '2016-10-12 04:15:15', '', 'Kitchen Whiteware', '', 'publish', 'closed', 'closed', '', 'kitchen-whiteware', '', '', '2016-10-12 12:15:15', '2016-10-12 04:15:15', '', 33, 'http://stoneappliance.co.nz/cn/?page_id=43', 4, 'page', '', 0),
(44, 1, '2016-10-12 12:15:15', '2016-10-12 04:15:15', '', 'Kitchen Whiteware', '', 'inherit', 'closed', 'closed', '', '43-revision-v1', '', '', '2016-10-12 12:15:15', '2016-10-12 04:15:15', '', 43, 'http://stoneappliance.co.nz/cn/2016/10/12/43-revision-v1/', 0, 'revision', '', 0),
(45, 1, '2016-10-12 12:15:31', '2016-10-12 04:15:31', '', 'Support', '', 'publish', 'closed', 'closed', '', 'support', '', '', '2016-10-12 12:15:31', '2016-10-12 04:15:31', '', 0, 'http://stoneappliance.co.nz/cn/?page_id=45', 0, 'page', '', 0),
(46, 1, '2016-10-12 12:15:31', '2016-10-12 04:15:31', '', 'Support', '', 'inherit', 'closed', 'closed', '', '45-revision-v1', '', '', '2016-10-12 12:15:31', '2016-10-12 04:15:31', '', 45, 'http://stoneappliance.co.nz/cn/2016/10/12/45-revision-v1/', 0, 'revision', '', 0),
(47, 1, '2016-10-12 12:15:56', '2016-10-12 04:15:56', '', 'Kitchentrend.Mag', '', 'publish', 'closed', 'closed', '', 'kitchentrend-mag', '', '', '2016-10-12 12:15:56', '2016-10-12 04:15:56', '', 0, 'http://stoneappliance.co.nz/cn/?page_id=47', 0, 'page', '', 0),
(48, 1, '2016-10-12 12:15:56', '2016-10-12 04:15:56', '', 'Kitchentrend.Mag', '', 'inherit', 'closed', 'closed', '', '47-revision-v1', '', '', '2016-10-12 12:15:56', '2016-10-12 04:15:56', '', 47, 'http://stoneappliance.co.nz/cn/2016/10/12/47-revision-v1/', 0, 'revision', '', 0),
(49, 1, '2016-10-12 12:16:00', '2016-10-12 04:16:00', '', 'Kitchentrend.Mag', '', 'inherit', 'closed', 'closed', '', '47-autosave-v1', '', '', '2016-10-12 12:16:00', '2016-10-12 04:16:00', '', 47, 'http://stoneappliance.co.nz/cn/2016/10/12/47-autosave-v1/', 0, 'revision', '', 0),
(50, 1, '2016-10-12 12:16:11', '2016-10-12 04:16:11', '', 'Contact Us', '', 'publish', 'closed', 'closed', '', 'contact-us', '', '', '2016-10-12 12:16:11', '2016-10-12 04:16:11', '', 0, 'http://stoneappliance.co.nz/cn/?page_id=50', 0, 'page', '', 0),
(51, 1, '2016-10-12 12:16:11', '2016-10-12 04:16:11', '', 'Contact Us', '', 'inherit', 'closed', 'closed', '', '50-revision-v1', '', '', '2016-10-12 12:16:11', '2016-10-12 04:16:11', '', 50, 'http://stoneappliance.co.nz/cn/2016/10/12/50-revision-v1/', 0, 'revision', '', 0),
(52, 1, '2016-10-12 12:16:26', '0000-00-00 00:00:00', '', '首页', '', 'draft', 'closed', 'closed', '', '', '', '', '2016-10-12 12:16:26', '0000-00-00 00:00:00', '', 0, 'http://stoneappliance.co.nz/cn/?p=52', 1, 'nav_menu_item', '', 0),
(53, 1, '2016-10-12 12:16:26', '0000-00-00 00:00:00', ' ', '', '', 'draft', 'closed', 'closed', '', '', '', '', '2016-10-12 12:16:26', '0000-00-00 00:00:00', '', 0, 'http://stoneappliance.co.nz/cn/?p=53', 1, 'nav_menu_item', '', 0),
(54, 1, '2016-10-12 12:16:26', '0000-00-00 00:00:00', ' ', '', '', 'draft', 'closed', 'closed', '', '', '', '', '2016-10-12 12:16:26', '0000-00-00 00:00:00', '', 0, 'http://stoneappliance.co.nz/cn/?p=54', 1, 'nav_menu_item', '', 0),
(55, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '55', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 0, 'http://stoneappliance.co.nz/cn/?p=55', 1, 'nav_menu_item', '', 0),
(56, 1, '2016-10-12 12:16:26', '0000-00-00 00:00:00', ' ', '', '', 'draft', 'closed', 'closed', '', '', '', '', '2016-10-12 12:16:26', '0000-00-00 00:00:00', '', 0, 'http://stoneappliance.co.nz/cn/?p=56', 1, 'nav_menu_item', '', 0),
(57, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '57', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 0, 'http://stoneappliance.co.nz/cn/?p=57', 2, 'nav_menu_item', '', 0),
(58, 1, '2016-10-12 12:16:26', '0000-00-00 00:00:00', ' ', '', '', 'draft', 'closed', 'closed', '', '', '', '', '2016-10-12 12:16:26', '0000-00-00 00:00:00', '', 33, 'http://stoneappliance.co.nz/cn/?p=58', 1, 'nav_menu_item', '', 0),
(59, 1, '2016-10-12 12:16:26', '0000-00-00 00:00:00', ' ', '', '', 'draft', 'closed', 'closed', '', '', '', '', '2016-10-12 12:16:26', '0000-00-00 00:00:00', '', 33, 'http://stoneappliance.co.nz/cn/?p=59', 1, 'nav_menu_item', '', 0),
(60, 1, '2016-10-12 12:16:26', '0000-00-00 00:00:00', ' ', '', '', 'draft', 'closed', 'closed', '', '', '', '', '2016-10-12 12:16:26', '0000-00-00 00:00:00', '', 33, 'http://stoneappliance.co.nz/cn/?p=60', 1, 'nav_menu_item', '', 0),
(61, 1, '2016-10-12 12:16:26', '0000-00-00 00:00:00', ' ', '', '', 'draft', 'closed', 'closed', '', '', '', '', '2016-10-12 12:16:26', '0000-00-00 00:00:00', '', 33, 'http://stoneappliance.co.nz/cn/?p=61', 1, 'nav_menu_item', '', 0),
(62, 1, '2016-10-12 12:16:26', '0000-00-00 00:00:00', ' ', '', '', 'draft', 'closed', 'closed', '', '', '', '', '2016-10-12 12:16:26', '0000-00-00 00:00:00', '', 33, 'http://stoneappliance.co.nz/cn/?p=62', 1, 'nav_menu_item', '', 0),
(63, 1, '2016-10-12 12:16:26', '0000-00-00 00:00:00', ' ', '', '', 'draft', 'closed', 'closed', '', '', '', '', '2016-10-12 12:16:26', '0000-00-00 00:00:00', '', 0, 'http://stoneappliance.co.nz/cn/?p=63', 1, 'nav_menu_item', '', 0),
(64, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '64', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 2, 'http://stoneappliance.co.nz/cn/?p=64', 3, 'nav_menu_item', '', 0),
(65, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '65', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 2, 'http://stoneappliance.co.nz/cn/?p=65', 6, 'nav_menu_item', '', 0),
(66, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '66', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 2, 'http://stoneappliance.co.nz/cn/?p=66', 5, 'nav_menu_item', '', 0),
(67, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '67', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 2, 'http://stoneappliance.co.nz/cn/?p=67', 4, 'nav_menu_item', '', 0),
(68, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '68', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 2, 'http://stoneappliance.co.nz/cn/?p=68', 7, 'nav_menu_item', '', 0),
(69, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '69', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 8, 'http://stoneappliance.co.nz/cn/?p=69', 9, 'nav_menu_item', '', 0),
(70, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '70', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 8, 'http://stoneappliance.co.nz/cn/?p=70', 11, 'nav_menu_item', '', 0),
(71, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '71', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 8, 'http://stoneappliance.co.nz/cn/?p=71', 10, 'nav_menu_item', '', 0),
(72, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '72', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 0, 'http://stoneappliance.co.nz/cn/?p=72', 8, 'nav_menu_item', '', 0),
(73, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '73', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 0, 'http://stoneappliance.co.nz/cn/?p=73', 13, 'nav_menu_item', '', 0),
(74, 1, '2016-10-12 12:19:21', '2016-10-12 04:19:21', ' ', '', '', 'publish', 'closed', 'closed', '', '74', '', '', '2016-10-12 12:19:37', '2016-10-12 04:19:37', '', 0, 'http://stoneappliance.co.nz/cn/?p=74', 12, 'nav_menu_item', '', 0),
(76, 1, '2016-10-12 12:44:42', '2016-10-12 04:44:42', '<p style="text-align: center;">[2jslideshow id="22995"]</p>\n<p style="text-align: center;"><img class="aligncenter wp-image-77 size-full" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/service_img.jpg" alt="service_img" width="1139" height="86" /></p>\n<p style="text-align: center;"><img class="alignnone size-full wp-image-78" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-1.jpg" alt="images-1" width="259" height="194" /></p>\n\n<div class="items-group no-divider">\n<div class="content-block">\n<div class="content-block-inner">\n<div class="text-section">\n\n<p style="text-align: left;">Thank you for choosing a Concept home appliance. To make sure you get the best care if repair should be necessary, Concept offers comprehensive service for your appliance, in the high quality you have come to expect.</p>\n<p style="text-align: left;">                              <img class="wp-image-79 alignnone" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/contact_us-1.jpg" alt="contact_us-1" width="160" height="171" />               <img class="alignnone wp-image-80" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/shop-150x150.jpg" alt="shop-150x150" width="170" height="170" />                    <img class="alignnone wp-image-81" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-2-150x150.jpg" alt="images-2-150x150" width="170" height="170" /></p>', 'Home', '', 'inherit', 'closed', 'closed', '', '26-autosave-v1', '', '', '2016-10-12 12:44:42', '2016-10-12 04:44:42', '', 26, 'http://stoneappliance.co.nz/cn/2016/10/12/26-autosave-v1/', 0, 'revision', '', 0),
(77, 1, '2016-10-12 12:34:51', '2016-10-12 04:34:51', '', 'service_img', '', 'inherit', 'open', 'closed', '', 'service_img', '', '', '2016-10-12 12:34:51', '2016-10-12 04:34:51', '', 26, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/service_img.jpg', 0, 'attachment', 'image/jpeg', 0),
(78, 1, '2016-10-12 12:36:57', '2016-10-12 04:36:57', '', 'images-1', '', 'inherit', 'open', 'closed', '', 'images-1', '', '', '2016-10-12 12:36:57', '2016-10-12 04:36:57', '', 26, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-1.jpg', 0, 'attachment', 'image/jpeg', 0),
(79, 1, '2016-10-12 12:38:02', '2016-10-12 04:38:02', '', 'contact_us-1', '', 'inherit', 'open', 'closed', '', 'contact_us-1', '', '', '2016-10-12 12:38:02', '2016-10-12 04:38:02', '', 26, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/contact_us-1.jpg', 0, 'attachment', 'image/jpeg', 0),
(80, 1, '2016-10-12 12:39:27', '2016-10-12 04:39:27', '', 'shop-150x150', '', 'inherit', 'open', 'closed', '', 'shop-150x150', '', '', '2016-10-12 12:39:27', '2016-10-12 04:39:27', '', 26, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/shop-150x150.jpg', 0, 'attachment', 'image/jpeg', 0),
(81, 1, '2016-10-12 12:40:29', '2016-10-12 04:40:29', '', 'images-2-150x150', '', 'inherit', 'open', 'closed', '', 'images-2-150x150', '', '', '2016-10-12 12:40:29', '2016-10-12 04:40:29', '', 26, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-2-150x150.jpg', 0, 'attachment', 'image/jpeg', 0),
(82, 1, '2016-10-12 12:41:38', '2016-10-12 04:41:38', '<p style="text-align: center;">[2jslideshow id="22995"]</p>\r\n<p style="text-align: center;"><img class="aligncenter wp-image-77 size-full" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/service_img.jpg" alt="service_img" width="1139" height="86" /></p>\r\n<p style="text-align: center;"><img class="alignnone size-full wp-image-78" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-1.jpg" alt="images-1" width="259" height="194" /></p>\r\n<p style="text-align: left;">Thank you for choosing a Concept home appliance. To make sure you get the best care if repair should be necessary, Concept offers comprehensive service for your appliance, in the high quality you have come to expect.</p>\r\n<p style="text-align: left;">                    <img class="alignnone wp-image-79" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/contact_us-1.jpg" alt="contact_us-1" width="160" height="171" />               <img class="alignnone wp-image-80" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/shop-150x150.jpg" alt="shop-150x150" width="170" height="170" />                    <img class="alignnone wp-image-81" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-2-150x150.jpg" alt="images-2-150x150" width="170" height="170" /></p>', 'Home', '', 'inherit', 'closed', 'closed', '', '26-revision-v1', '', '', '2016-10-12 12:41:38', '2016-10-12 04:41:38', '', 26, 'http://stoneappliance.co.nz/cn/2016/10/12/26-revision-v1/', 0, 'revision', '', 0),
(83, 1, '2016-10-12 12:42:37', '2016-10-12 04:42:37', '<p style="text-align: center;">[2jslideshow id="22995"]</p>\r\n<p style="text-align: center;"><img class="aligncenter wp-image-77 size-full" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/service_img.jpg" alt="service_img" width="1139" height="86" /></p>\r\n<p style="text-align: center;"><img class="alignnone size-full wp-image-78" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-1.jpg" alt="images-1" width="259" height="194" /></p>\r\n<p style="text-align: left;">Thank you for choosing a Concept home appliance. To make sure you get the best care if repair should be necessary, Concept offers comprehensive service for your appliance, in the high quality you have come to expect.</p>\r\n<p style="text-align: left;">                              <img class="wp-image-79 alignnone" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/contact_us-1.jpg" alt="contact_us-1" width="160" height="171" />               <img class="alignnone wp-image-80" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/shop-150x150.jpg" alt="shop-150x150" width="170" height="170" />                    <img class="alignnone wp-image-81" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-2-150x150.jpg" alt="images-2-150x150" width="170" height="170" /></p>', 'Home', '', 'inherit', 'closed', 'closed', '', '26-revision-v1', '', '', '2016-10-12 12:42:37', '2016-10-12 04:42:37', '', 26, 'http://stoneappliance.co.nz/cn/2016/10/12/26-revision-v1/', 0, 'revision', '', 0),
(84, 1, '2016-10-12 12:46:38', '2016-10-12 04:46:38', '<p style="text-align: center;">[2jslideshow id="22995"]</p>\r\n<p style="text-align: center;"><img class="aligncenter wp-image-77 size-full" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/service_img.jpg" alt="service_img" width="1139" height="86" /></p>\r\n<p style="text-align: center;"><img class="alignnone size-full wp-image-78" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-1.jpg" alt="images-1" width="259" height="194" /></p>\r\n\r\n<div class="items-group no-divider">\r\n<div class="content-block">\r\n<div class="content-block-inner">\r\n<div class="text-section">\r\n\r\n<span style="font-size: 15px;">Thank you for choosing a Concept home appliance. To make sure you get the best care if repair should be necessary, Concept offers comprehensive service for your appliance, in the high quality you have come to expect.</span>\r\n<a href="http://localhost:8080/wordpress/?page_id=22721"><img class="alignnone wp-image-23015" style="margin-left: 100px;" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/contact_us-1.jpg" alt="contact_us" width="160" height="171" /></a>                            <a href=" http://localhost:8080/conceptkitchen/?page_id=22698"><img class="alignnone wp-image-23011" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/shop-150x150.jpg" alt="shop" width="170" height="170" /></a>                   <a href=" http://localhost:8080/conceptkitchen/?page_id=22711"><img class="alignnone wp-image-23010" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-2-150x150.jpg" alt="images" width="170" height="170" /></a>\r\n\r\n</div>\r\n</div>\r\n</div>\r\n</div>', 'Home', '', 'inherit', 'closed', 'closed', '', '26-revision-v1', '', '', '2016-10-12 12:46:38', '2016-10-12 04:46:38', '', 26, 'http://stoneappliance.co.nz/cn/2016/10/12/26-revision-v1/', 0, 'revision', '', 0),
(85, 1, '2016-10-12 12:50:09', '2016-10-12 04:50:09', '', 'logo', '', 'inherit', 'open', 'closed', '', 'logo', '', '', '2016-10-12 12:50:09', '2016-10-12 04:50:09', '', 0, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/logo.png', 0, 'attachment', 'image/png', 0),
(86, 1, '2016-10-12 12:59:00', '2016-10-12 04:59:00', '', 'home_slideshow', '', 'publish', 'open', 'closed', '', 'home_slideshow', '', '', '2016-10-12 13:35:07', '2016-10-12 05:35:07', '', 0, 'http://stoneappliance.co.nz/cn/?post_type=twoj_slideshow_post&#038;p=86', 0, 'twoj_slideshow_post', '', 0),
(87, 1, '2016-10-12 12:55:45', '2016-10-12 04:55:45', '', 'img-1', '', 'inherit', 'open', 'closed', '', 'img-1', '', '', '2016-10-12 12:55:45', '2016-10-12 04:55:45', '', 0, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/img-1.jpg', 0, 'attachment', 'image/jpeg', 0),
(88, 1, '2016-10-12 12:55:56', '2016-10-12 04:55:56', '', 'wechatimg14', '', 'inherit', 'open', 'closed', '', 'wechatimg14', '', '', '2016-10-12 12:55:56', '2016-10-12 04:55:56', '', 0, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/WechatIMG14.jpeg', 0, 'attachment', 'image/jpeg', 0),
(89, 1, '2016-10-12 12:57:07', '2016-10-12 04:57:07', '', 'contemporary-kitchen-art-decor', '', 'inherit', 'open', 'closed', '', 'contemporary-kitchen-art-decor', '', '', '2016-10-12 12:57:07', '2016-10-12 04:57:07', '', 0, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/contemporary-kitchen-art-decor.jpg', 0, 'attachment', 'image/jpeg', 0),
(90, 1, '2016-10-12 12:57:44', '2016-10-12 04:57:44', '', 'img-2', '', 'inherit', 'open', 'closed', '', 'img-2', '', '', '2016-10-12 12:57:44', '2016-10-12 04:57:44', '', 0, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/img-2.jpg', 0, 'attachment', 'image/jpeg', 0),
(91, 1, '2016-10-12 12:58:18', '2016-10-12 04:58:18', '', 'brandlogo', '', 'inherit', 'open', 'closed', '', 'brandlogo', '', '', '2016-10-12 12:58:18', '2016-10-12 04:58:18', '', 0, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/brandlogo.jpg', 0, 'attachment', 'image/jpeg', 0),
(92, 1, '2016-10-12 12:59:45', '2016-10-12 04:59:45', '<p style="text-align: center;">[twoj-slideshow id="86"]</p>\r\n<p style="text-align: center;"><img class="aligncenter wp-image-77 size-full" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/service_img.jpg" alt="service_img" width="1139" height="86" /></p>\r\n<p style="text-align: center;"><img class="alignnone size-full wp-image-78" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-1.jpg" alt="images-1" width="259" height="194" /></p>\r\n\r\n<div class="items-group no-divider">\r\n<div class="content-block">\r\n<div class="content-block-inner">\r\n<div class="text-section">\r\n\r\n<span style="font-size: 15px;">Thank you for choosing a Concept home appliance. To make sure you get the best care if repair should be necessary, Concept offers comprehensive service for your appliance, in the high quality you have come to expect.</span>\r\n<a href="http://localhost:8080/wordpress/?page_id=22721"><img class="alignnone wp-image-23015" style="margin-left: 100px;" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/contact_us-1.jpg" alt="contact_us" width="160" height="171" /></a>                            <a href=" http://localhost:8080/conceptkitchen/?page_id=22698"><img class="alignnone wp-image-23011" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/shop-150x150.jpg" alt="shop" width="170" height="170" /></a>                   <a href=" http://localhost:8080/conceptkitchen/?page_id=22711"><img class="alignnone wp-image-23010" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-2-150x150.jpg" alt="images" width="170" height="170" /></a>\r\n\r\n</div>\r\n</div>\r\n</div>\r\n</div>', 'Home', '', 'inherit', 'closed', 'closed', '', '26-revision-v1', '', '', '2016-10-12 12:59:45', '2016-10-12 04:59:45', '', 26, 'http://stoneappliance.co.nz/cn/2016/10/12/26-revision-v1/', 0, 'revision', '', 0),
(93, 1, '2016-10-12 13:04:14', '2016-10-12 05:04:14', '<p style="text-align: center;">[2jslideshow id="86"]</p>\r\n<p style="text-align: center;"><img class="aligncenter wp-image-77 size-full" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/service_img.jpg" alt="service_img" width="1139" height="86" /></p>\r\n<p style="text-align: center;"><img class="alignnone size-full wp-image-78" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-1.jpg" alt="images-1" width="259" height="194" /></p>\r\n\r\n<div class="items-group no-divider">\r\n<div class="content-block">\r\n<div class="content-block-inner">\r\n<div class="text-section">\r\n\r\n<span style="font-size: 15px;">Thank you for choosing a Concept home appliance. To make sure you get the best care if repair should be necessary, Concept offers comprehensive service for your appliance, in the high quality you have come to expect.</span>\r\n<a href="http://localhost:8080/wordpress/?page_id=22721"><img class="alignnone wp-image-23015" style="margin-left: 100px;" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/contact_us-1.jpg" alt="contact_us" width="160" height="171" /></a>                            <a href=" http://localhost:8080/conceptkitchen/?page_id=22698"><img class="alignnone wp-image-23011" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/shop-150x150.jpg" alt="shop" width="170" height="170" /></a>                   <a href=" http://localhost:8080/conceptkitchen/?page_id=22711"><img class="alignnone wp-image-23010" src="http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/images-2-150x150.jpg" alt="images" width="170" height="170" /></a>\r\n\r\n</div>\r\n</div>\r\n</div>\r\n</div>', 'Home', '', 'inherit', 'closed', 'closed', '', '26-revision-v1', '', '', '2016-10-12 13:04:14', '2016-10-12 05:04:14', '', 26, 'http://stoneappliance.co.nz/cn/2016/10/12/26-revision-v1/', 0, 'revision', '', 0),
(94, 1, '2016-10-12 14:02:50', '2016-10-12 06:02:50', '<p style="text-align: left;">[Total_Soft_Gallery_Video id="1"]</p>\r\nThe kitchen is the heart of a home; it is where meals are cooked, meaning conversations happen, and everyone gets the bulk of their nutrition, both physical and emotional. There is something to be said for a sweet, quaint little space, and there is also something significant about a super-sleek, ultra-modern space with all the latest finishes. Kitchen is the hub of your home.\r\n\r\n[slideshow_deploy id=''23024'']', 'Furniture–one', '', 'inherit', 'closed', 'closed', '', '23-revision-v1', '', '', '2016-10-12 14:02:50', '2016-10-12 06:02:50', '', 23, 'http://stoneappliance.co.nz/cn/2016/10/12/23-revision-v1/', 0, 'revision', '', 0),
(95, 1, '2016-10-12 14:08:28', '2016-10-12 06:08:28', '', 'Furniture-one slideshow', '', 'publish', 'closed', 'closed', '', 'furniture-one-slideshow', '', '', '2016-10-12 14:11:01', '2016-10-12 06:11:01', '', 0, 'http://stoneappliance.co.nz/cn/?post_type=slideshow&#038;p=95', 0, 'slideshow', '', 0),
(102, 1, '2016-10-12 14:10:55', '2016-10-12 06:10:55', '', '333', '', 'inherit', 'open', 'closed', '', '333', '', '', '2016-10-12 14:10:55', '2016-10-12 06:10:55', '', 0, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/333.jpg', 0, 'attachment', 'image/jpeg', 0),
(101, 1, '2016-10-12 14:10:46', '2016-10-12 06:10:46', '', '222', '', 'inherit', 'open', 'closed', '', '222', '', '', '2016-10-12 14:10:46', '2016-10-12 06:10:46', '', 0, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/222.jpg', 0, 'attachment', 'image/jpeg', 0),
(100, 1, '2016-10-12 14:10:39', '2016-10-12 06:10:39', '', '111', '', 'inherit', 'open', 'closed', '', '111', '', '', '2016-10-12 14:10:39', '2016-10-12 06:10:39', '', 0, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/111.jpg', 0, 'attachment', 'image/jpeg', 0),
(99, 1, '2016-10-12 14:09:02', '2016-10-12 06:09:02', '<p style="text-align: left;">[Total_Soft_Gallery_Video id="1"]</p>\r\nThe kitchen is the heart of a home; it is where meals are cooked, meaning conversations happen, and everyone gets the bulk of their nutrition, both physical and emotional. There is something to be said for a sweet, quaint little space, and there is also something significant about a super-sleek, ultra-modern space with all the latest finishes. Kitchen is the hub of your home.\r\n\r\n[slideshow_deploy id=''95'']', 'Furniture–one', '', 'inherit', 'closed', 'closed', '', '23-revision-v1', '', '', '2016-10-12 14:09:02', '2016-10-12 06:09:02', '', 23, 'http://stoneappliance.co.nz/cn/2016/10/12/23-revision-v1/', 0, 'revision', '', 0),
(103, 1, '2016-10-12 14:12:54', '2016-10-12 06:12:54', '', 'net-study-progress', '', 'inherit', 'open', 'closed', '', 'net-study-progress', '', '', '2016-10-12 14:12:54', '2016-10-12 06:12:54', '', 5, 'http://stoneappliance.co.nz/cn/wp-content/uploads/2016/10/Net-study-progress.pdf', 0, 'attachment', 'application/pdf', 0),
(105, 1, '2016-10-12 14:14:59', '2016-10-12 06:14:59', 'It''s very difficult to say who did the scratches and who should responsible for that,so we suggest you''d better choose carefully before you buy.', 'What if there are some scratches on the new furniture?', '', 'publish', 'open', 'closed', '', 'what-if-there-are-some-scratches-on-the-new-furniture', '', '', '2016-10-12 14:19:47', '2016-10-12 06:19:47', '', 0, 'http://stoneappliance.co.nz/cn/?post_type=ufaq&#038;p=105', 0, 'ufaq', '', 0),
(106, 1, '2016-10-12 14:15:31', '2016-10-12 06:15:31', 'Thank you for your consultation!We have an experienced and professional team to provide all kinds of solution to your kitchen.From design,decorate to the furniture,all we do is to give our customers a beautiful and well-designed cooking space!', 'What kind of services do you provide?', '', 'publish', 'open', 'closed', '', 'what-kind-of-services-do-you-provide', '', '', '2016-10-12 14:20:12', '2016-10-12 06:20:12', '', 0, 'http://stoneappliance.co.nz/cn/?post_type=ufaq&#038;p=106', 0, 'ufaq', '', 0),
(107, 1, '2016-10-12 14:15:47', '0000-00-00 00:00:00', '', '自动草稿', '', 'auto-draft', 'open', 'closed', '', '', '', '', '2016-10-12 14:15:47', '0000-00-00 00:00:00', '', 0, 'http://stoneappliance.co.nz/cn/?post_type=ufaq&p=107', 0, 'ufaq', '', 0),
(108, 1, '2016-10-12 14:15:51', '0000-00-00 00:00:00', '', '自动草稿', '', 'auto-draft', 'open', 'closed', '', '', '', '', '2016-10-12 14:15:51', '0000-00-00 00:00:00', '', 0, 'http://stoneappliance.co.nz/cn/?post_type=ufaq&p=108', 0, 'ufaq', '', 0),
(109, 1, '2016-10-12 14:28:29', '2016-10-12 06:28:29', '[Total_Soft_Gallery_Video id="2"]', 'Gallery--one', '', 'inherit', 'closed', 'closed', '', '10-revision-v1', '', '', '2016-10-12 14:28:29', '2016-10-12 06:28:29', '', 10, 'http://stoneappliance.co.nz/cn/2016/10/12/10-revision-v1/', 0, 'revision', '', 0);

-- --------------------------------------------------------

--
-- 表的结构 `wpcn_revslider_css`
--

CREATE TABLE IF NOT EXISTS `wpcn_revslider_css` (
...
--
-- 转存表中的数据 `wpcn_revslider_css`
--

INSERT INTO `wpcn_revslider_css` (`id`, `handle`, `settings`, `hover`, `params`) VALUES
...
--
-- 表的结构 `wpcn_revslider_layer_animations`
--

CREATE TABLE IF NOT EXISTS `wpcn_revslider_layer_animations` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `handle` text NOT NULL,
  `params` text NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- 表的结构 `wpcn_revslider_settings`
--

CREATE TABLE IF NOT EXISTS `wpcn_revslider_settings` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `wpcn_revslider_sliders`
--

CREATE TABLE IF NOT EXISTS `wpcn_revslider_sliders` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `wpcn_revslider_slides`
--

CREATE TABLE IF NOT EXISTS `wpcn_revslider_slides` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `wpcn_termmeta` (
  `meta_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `wpcn_terms` (
...
--
-- 表的结构 `wpcn_term_relationships`
--

CREATE TABLE IF NOT EXISTS `wpcn_term_relationships` (
...
--
-- 转存表中的数据 `wpcn_term_relationships`
--
...
--
-- 表的结构 `wpcn_term_taxonomy`
--

CREATE TABLE IF NOT EXISTS `wpcn_term_taxonomy` (
...
--
-- 表的结构 `wpcn_totalsoft_fonts`
--

CREATE TABLE IF NOT EXISTS `wpcn_totalsoft_fonts` (
...
--
-- 转存表中的数据 `wpcn_totalsoft_fonts`
--

INSERT INTO `wpcn_totalsoft_fonts` (`id`, `Font`) VALUES
...
--
-- 表的结构 `wpcn_totalsoft_galleryv_ctpg`
--

CREATE TABLE IF NOT EXISTS `wpcn_totalsoft_galleryv_ctpg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `wpcn_totalsoft_galleryv_dbt`
--

CREATE TABLE IF NOT EXISTS `wpcn_totalsoft_galleryv_dbt` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `TotalSoftGalleryV_SetName` varchar(255) NOT NULL,
  `TotalSoftGalleryV_SetType` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- 转存表中的数据 `wpcn_totalsoft_galleryv_dbt`
--

INSERT INTO `wpcn_totalsoft_galleryv_dbt` (`id`, `TotalSoftGalleryV_SetName`, `TotalSoftGalleryV_SetType`) VALUES
...
--
-- 表的结构 `wpcn_totalsoft_galleryv_gvg`
--

CREATE TABLE IF NOT EXISTS `wpcn_totalsoft_galleryv_gvg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `TotalSoftGalleryV_SetID` varchar(255) NOT NULL,
  `TotalSoftGalleryV_SetName` varchar(255) NOT NULL,
  `TotalSoftGalleryV_SetType` varchar(255) NOT NULL,
...
--
-- 表的结构 `wpcn_totalsoft_galleryv_hlg`
--

CREATE TABLE IF NOT EXISTS `wpcn_totalsoft_galleryv_hlg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `TotalSoftGalleryV_SetID` varchar(255) NOT NULL,
  `TotalSoftGalleryV_SetName` varchar(255) NOT NULL,
  `TotalSoftGalleryV_SetType` varchar(255) NOT NULL,
...
--
-- 表的结构 `wpcn_totalsoft_galleryv_id`
--

CREATE TABLE IF NOT EXISTS `wpcn_totalsoft_galleryv_id` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `wpcn_totalsoft_galleryv_id`
--

INSERT INTO `wpcn_totalsoft_galleryv_id` (`id`, `GalleryV_ID`) VALUES
(1, '1'),
(2, '2');
...
--
-- 表的结构 `wpcn_totalsoft_galleryv_lvg`
--

CREATE TABLE IF NOT EXISTS `wpcn_totalsoft_galleryv_lvg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `TotalSoftGalleryV_SetID` varchar(255) NOT NULL,
  `TotalSoftGalleryV_SetName` varchar(255) NOT NULL,
  `TotalSoftGalleryV_SetType` varchar(255) NOT NULL,
...
--
-- 表的结构 `wpcn_totalsoft_galleryv_manager`
--

CREATE TABLE IF NOT EXISTS `wpcn_totalsoft_galleryv_manager` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `wpcn_totalsoft_galleryv_manager`
--

INSERT INTO `wpcn_totalsoft_galleryv_manager` (`id`, `TotalSoftGallery_Video_Gallery_Title`, `TotalSoftGallery_Video_Option`, `TotalSoftGallery_Video_ShowType`, `TotalSoftGallery_Video_PerPage`, `TotalSoftGallery_LoadMore`) VALUES
...
--
-- 表的结构 `wpcn_totalsoft_galleryv_ttvg`
--

CREATE TABLE IF NOT EXISTS `wpcn_totalsoft_galleryv_ttvg` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `TotalSoftGalleryV_SetID` varchar(255) NOT NULL,
  `TotalSoftGalleryV_SetName` varchar(255) NOT NULL,
  `TotalSoftGalleryV_SetType` varchar(255) NOT NULL,
...
--
-- 表的结构 `wpcn_totalsoft_galleryv_videos`
--

CREATE TABLE IF NOT EXISTS `wpcn_totalsoft_galleryv_videos` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `wpcn_totalsoft_galleryv_videos`
--

INSERT INTO `wpcn_totalsoft_galleryv_videos` (`id`, `TotalSoftGallery_Video_VT`, `TotalSoftGallery_Video_VDesc`, `TotalSoftGallery_Video_VLink`, `TotalSoftGallery_Video_VONT`, `TotalSoftGallery_Video_VURL`, `TotalSoftGallery_Video_IURL`, `TotalSoftGallery_Video_Video`, `GalleryV_ID`) VALUES
...
CREATE TABLE IF NOT EXISTS `wpcn_usermeta` (
...
(10, 1, 'wpcn_capabilities', 'a:1:{s:13:"administrator";b:1;}'),
(11, 1, 'wpcn_user_level', '10'),
(12, 1, 'dismissed_wpcn_pointers', 'ufaq_admin_pointers_tutorial-one,ufaq_admin_pointers_tutorial-two,ufaq_admin_pointers_tutorial-three,ufaq_admin_pointers_tutorial-four,ufaq_admin_pointers_tutorial-five,ufaq_admin_pointers_tutorial-six'),
(13, 1, 'show_welcome_panel', '1'),
(14, 1, 'session_tokens', 'a:2:{s:64:"16a1f0a95590582bd18d334d674f33ad9d199062125e6c06f427a3f462a91b1b";a:4:{s:10:"expiration";i:1476416633;s:2:"ip";s:3:"::1";s:2:"ua";s:113:"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.89 Safari/537.36";s:5:"login";i:1476243833;}s:64:"6c0a69e8d82d11a99c6d88e9d0a7ad1ea8c1db60e808c2b3492f6e6cba0ecc54";a:4:{s:10:"expiration";i:1476431803;s:2:"ip";s:3:"::1";s:2:"ua";s:113:"Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.89 Safari/537.36";s:5:"login";i:1476259003;}}'),
(15, 1, 'wpcn_dashboard_quick_press_last_post_id', '3'),
(16, 1, 'wpcn_user-settings', 'libraryContent=browse&editor=tinymce'),
(17, 1, 'wpcn_user-settings-time', '1476244900'),
(18, 1, 'closedpostboxes_page', 'a:0:{}'),
(19, 1, 'metaboxhidden_page', 'a:0:{}'),
(20, 1, 'wpcn_r_tru_u_x', 'a:2:{s:2:"id";i:0;s:7:"expires";i:1476248676;}'),
...
CREATE TABLE IF NOT EXISTS `wpcn_users` (
  `ID` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
